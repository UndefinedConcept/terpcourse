...
<main class="flex flex-col gap-1 px-4 md:grid md:grid-cols-[22rem_1fr]">
	<section id="schedule" class="order-1 min-h-80 py-2 max-md:h-[50vh] md:order-2 md:h-[calc(100vh-3rem)]">
		<div class="flex h-full items-center justify-center rounded-lg bg-secondary">
			<p class="text-6xl font-bold">Schedule</p>
		</div>
	</section>
	<section
		class="order-2 scrollbar min-h-80 overflow-y-scroll pr-1 max-md:h-[90vh] md:order-1 md:h-[calc(100vh-3rem)]"
	>
		<Search />
		<Results />
	</section>
